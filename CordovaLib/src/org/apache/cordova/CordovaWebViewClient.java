...
//            keyStore.load(
//                    this.appView.getResources().openRawResource(R.raw.client),
//                    "suypower".toCharArray());
...
//        if ((null != mPrivateKey) && ((null != mX509Certificates) && (mX509Certificates.length != 0))) {
...
//        }
        ...
        PluginManager pluginManager = this.appView.pluginManager;
        if (pluginManager != null && pluginManager.onReceivedClientCertRequest(this.appView,
...
//        view.addJavascriptInterface(new InJavaScriptLocalObj(), "read_html");
...
//        view.loadUrl("javascript:window.read_html.showSource('<head>'+" +
...
//
//            if (html.contains("goBack"))
//                appView.isGoBack=true;
//
//            Log.d("HTML", html);
//        }
//    }
